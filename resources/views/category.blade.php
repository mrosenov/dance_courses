                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-start">
                        <div class="page-title">
                            <h3 class="title" style="text-transform: capitalize">{{$category->name}}</h3>
                        </div>
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <div class="status-group">
                                                <a href="{{route('view-category', $post->getCategory->name)}}" class="eduvibe-status status-05"><i class="icon-price-tag-3-line"></i> {{$post->getCategory->name}}</a>
                                            </div>
