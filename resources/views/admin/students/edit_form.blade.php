...
@section('section')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{route('students')}}">List of Students</a></li>
            ...
            <form method="POST" action="{{route('update-student', $student->id)}}">
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Student Name" value="{{$student->name}}" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="email" type="email" class="form-control" placeholder="Email" value="{{$student->email}}" required>
                    </div>

                    <div class="input-group mb-3">
                        <select class="form-control" name="country" required>
                            @foreach($countries as $country)
                                <option value="{{$country}}" @if($student->country == $country) selected @endif>{{$country}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="town" type="text" class="form-control" placeholder="Town" value="{{$student->town}}" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="postcode" type="number" class="form-control" placeholder="Post Code" value="{{$student->postcode}}" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="address" type="text" class="form-control" placeholder="Street Address" value="{{$student->address}}" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="phone" type="number" class="form-control" placeholder="Phone" value="{{$student->phone}}" required>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="birthday" type="date" class="form-control" data-mask="00/00/0000" value="{{$student->birthday}}" required>
                    </div>
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="contactperson" type="text" class="form-control" placeholder="Person for contact" value="{{$student->contactperson}}">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="contactpersonphone" type="number" class="form-control" placeholder="Person for contact phone" value="{{$student->contactpersonphone}}">
                    </div>
                </fieldset>
                ...
                <fieldset class="border p-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" onchange="RoleCheck(this);" name="role" required>
                            ...
                            <option value="Teacher" @if($student->role == 'Teacher') selected @endif>Teacher</option>
                            <option value="Student" @if($student->role == 'Student') selected @endif>Student</option>
                        </select>
                    </div>

                    <fieldset class="border p-2 mb-2" id="TeacherOptions" @if($student->role != 'Teacher')style="display: none;" @endif>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="short_description" type="text" class="form-control" placeholder="Short description for teacher.">
                        </div>
